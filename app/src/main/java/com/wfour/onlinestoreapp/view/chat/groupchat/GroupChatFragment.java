...
import com.wfour.onlinestoreapp.view.chat.chatutils.TextUtils;
...
//        if (idUser != 1) {
//            tvNameProduct.setText(item.getTitle());
//            tvPrice.setPaintFlags(tvPrice.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG);
//            tvDeal.setText(" $"+StringUtil.convertNumberToString(item.getPrice(),2));
//            if (item.getOld_price() == 0) {
//                tvPrice.setVisibility(View.GONE);
//            }
//            tvPrice.setText(" $"+ StringUtil.convertNumberToString(item.getOld_price(),2));
        ...
        SendBird.addChannelHandler(CHANNEL_HANDLER_ID, new SendBird.ChannelHandler() {
            ...
            public void onTypingStatusUpdated(GroupChannel channel) {
                if (channel.getUrl().equals(mChannelUrl)) {
                    ...
                    Log.e("onTypingStatusUpdated", "onTypingStatusUpdated: ");
                }
            }
